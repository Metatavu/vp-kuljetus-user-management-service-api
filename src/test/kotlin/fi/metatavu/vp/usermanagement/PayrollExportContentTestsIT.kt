...
class PayrollExportContentTestsIT: AbstractFunctionalTest() {
    ...
    @Test
    fun testPayrollExportOfficeWorkerOverTimeWithAbsence() = createTestBuilder().use {
        val employee = it.manager.employees.createEmployee("1212")

        it.manager.employees.updateEmployee(
            employeeId = employee.id!!,
            employee = employee.copy(
                regularWorkingHours = 0f,
                salaryGroup = SalaryGroup.OFFICE
            )
        )
        ...
        it.manager.workEvents.createWorkEvent(
            ...
            workEvent = WorkEvent(
                employeeId = employee.id,
                time = date.minusHours(4).toString(),
                workEventType = WorkEventType.DRIVE
            )
        )
        ...
        val previousDayRow2 = "$formattedDate2;1212;Test Employee;20050;2.00;;;;;"
        val previousDayRow3 = "$formattedDate2;1212;Test Employee;20060;2.00;;;;;"
        val currentDayRow1 = "$formattedDate;1212;Test Employee;11000;8.00;;;;;"
        val currentDayRow2 = "$formattedDate;1212;Test Employee;20050;2.00;;;;;"
        val currentDayRow3 = "$formattedDate;1212;Test Employee;20060;0.67;;;;;"
